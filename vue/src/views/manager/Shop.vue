  ...
  <div>
    ...
    <el-card>
      <div style="margin-bottom: 10px">
        <el-input style="width: 200px" placeholder="查询账号" v-model="username"></el-input>
        <el-input style="width: 200px; margin: 0 5px" placeholder="查询店铺名" v-model="name"></el-input>
      ...
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="infos" label="店铺介绍"></el-table-column>
    ...
    <el-drawer :visible.sync="formDetailVisible" title="详情" :with-header="false">
      ...
      <div class="drawer-content" ref="drawerContent">
        <el-form label-width="100px" style="padding-right: 40px" :model="form">
          ...
          <el-form-item label="店铺介绍" prop="infos">
            <div>{{form.infos}}</div>
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {   // 新增数据
      this.form = {role: 'SHOP'}  // 新增数据的时候清空数据
      this.fromVisible = true   // 打开弹窗
    },
