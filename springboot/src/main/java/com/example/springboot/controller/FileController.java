...
public class FileController {
    ...
    public List<Map<String,String>> mulUpload(@RequestParam MultipartFile[] file) throws IOException {
        List<Map<String,String>> files = new ArrayList<>();
        for (MultipartFile multipartFile : file) {
            String originalFilename = multipartFile.getOriginalFilename();  // 文件的原始名称
            // aaa.png
            ...
            multipartFile.transferTo(saveFile);  // 存储文件到本地的磁盘里面去
